...
| <a name="input_pipeline_schedule"></a> [pipeline\_schedule](#input\_pipeline\_schedule) | n/a | <pre>object({<br>    cron           = string<br>    activate       = optiona(bool)<br>    cron_timezone  = optional(string)<br>    description    = optional(string)<br>    take_ownership = optional(bool)<br>    ref            = optional(string)<br>  })</pre> | <pre>{<br>  "activate": true,<br>  "cron": null,<br>  "cron_timezone": "UTC",<br>  "description": null,<br>  "ref": "main",<br>  "take_ownership": false<br>}</pre> | no |
