...
| <a name="input_pipeline_schedule"></a> [pipeline\_schedule](#input\_pipeline\_schedule) | n/a | <pre>object({<br>    cron        = string<br>    description = optional(string)<br>    ref         = optional(string)<br>  })</pre> | <pre>{<br>  "cron": null,<br>  "description": null,<br>  "ref": "main"<br>}</pre> | no |
