...
| <a name="input_pipeline_schedule"></a> [pipeline\_schedule](#input\_pipeline\_schedule) | n/a | <pre>object({<br>    active         = optional(bool, true)<br>    cron           = string<br>    cron_timezone  = optional(string, "UTC")<br>    description    = string<br>    ref            = optional(string, "refs/heads/main")<br>    take_ownership = optional(bool, false)<br>  })</pre> | `null` | no |
